...
//
//	stepMove.wheelStepByStep("#tableCellThree", 100, "x", 20, "%");
//	stepMove.touchStepByStep("#tableCellThree", 100, "x", 20, "%");
//	
// stepMove.wheelStepByStep("#second", 100, "y", 200, "px");
/* stepMove.wheelStepByStep("#second", 100, "y", 200, "px")被引用到js2/pageTwo_setting.js 的window.onload**/


/*css2/jquery.fullPage.css 52行做出如下更改*/
/*
#pageThree .fp-tableCell{
	overflow: scroll;
	transition: all 1s; 
}
*/
